% ------------------------------------------------------------------------------------------------------------------------------------
% ------------------------------------------------------------------------------------------------------------------------------------
% Current file is a modified version of the original TeX file, which was written by Paul Torfs & Claudia
% Brauer. It's the basic file for the greek translation of their respective introductory tutorial in R. 
% ------------------------------------------------------------------------------------------------------------------------------------
% ------------------------------------------------------------------------------------------------------------------------------------

\documentclass[a4paper,11pt,twocolumn,tablecaptionabove]{scrartcl} % instead of scrbook
...
% \verb!...! is only used instead of \texttt{...} when there are brackets or other things \texttt can't handle.
